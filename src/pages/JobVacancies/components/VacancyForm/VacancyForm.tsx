...
export const VacancyForm: React.FC<IVacancyForm> = ({
  ...
  const removeEssentialRequirment = (requirment: string) => {
    setJobForm((prev) => ({
      ...prev,
      essentialRequirments: prev.requirementsEssential.filter(
  ...
  const removeDesiredRequirment = (requirment: string) => {
    setJobForm((prev) => ({
      ...prev,
      desiredRequirments: prev.requirementsDesirable.filter(
        (item) => item !== requirment
      ),
    }));
  };
          ...
          <div className="form-list-subcontainer">
            ...
            <div className="requirment-button-container">
              ...
              <button
                type="button"
                className="standard-button"
                onClick={() => clearJobFormArray("essentialRequirments")}
              >
                clear
              </button>
            </div>
          ...
          <div className="form-list-subcontainer">
            ...
            <div className="requirment-button-container">
              ...
              <button
                type="button"
                className="standard-button"
                onClick={() => clearJobFormArray("desiredRequirments")}
              >
                clear
              </button>
            </div>
