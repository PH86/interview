export { JobVacanciesList } from "pages/JobVacancies/components/JobVacanciesList/JobVacanciesList";
export { VacancyCard } from "pages/JobVacancies/components/VacancyCard/VacancyCard";
